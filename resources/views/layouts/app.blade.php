...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="{{route('guage')}}">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Dashboard V2</span></a>
            </li>
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="noti ScrollStyle">
                            
                            </div>
                                <a class="dropdown-item text-center small text-gray-500" onclick="updatenotificationcount();" href="#">Mark all as read</a>
                            </div>
                        </li>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; AAQOOTECH</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
